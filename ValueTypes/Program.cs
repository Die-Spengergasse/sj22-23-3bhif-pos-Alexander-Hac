...
namespace ValueTypes
{
    class TypeExercise
    {
        ...
        /// </summary>d
        public double BerechneSchuelerProKlasse(int schuelerGesamt, int klassenGesamt) => (double)schuelerGesamt / (double)klassenGesamt;
        ...
        /// </summary>
        public int BerechneAchtel(long wert) => (int)wert / 8;
